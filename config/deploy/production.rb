...
after 'deploy:update_code' do
  ...
  run "cd #{release_path} && RAILS_ENV=development bundle exec rake sunspot:solr:start"
  run "cd #{release_path} && RAILS_ENV=development bundle exec rake sunspot:solr:reindex"
